...
export function About() {
  return (
    <section className="flex flex-col gap-7.5 w-full max-w-7xl mx-auto px-10 mt-20 lg:flex-row xl:px-0 lg:mt-40">
      <div className="flex flex-col w-full lg:max-w-[50%] gap-7.5 lg:gap-10">
        ...
        <p className="lg:text-lg text-justify">
          ...
          by engineering robust solutions that provide a smooth and captivating
          user experience within the modern TypeScript ecosystem.
        </p>
      </div>
