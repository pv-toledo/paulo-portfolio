        ...
        {/* <div className="flex flex-col gap-5 mt-4 lg:flex-row lg:gap-10 lg:mt-0">
          ...
          >
            <Button size="lg" className="gap-2.5 cursor-pointer">
              {isComponentMounted &&
                (theme === "light" ? (
                  <Icons.githubLight className="!w-5 !h-5 lg:!w-7 lg:!h-7" />
                ) : (
                  <Icons.gitHubDark className="!w-5 !h-5 lg:!w-7 lg:!h-7" />
                ))}
              <span className="text-sm lg:text-lg">Check my Github</span>
            </Button>
          </Link>
        </div> */}
      </div>
